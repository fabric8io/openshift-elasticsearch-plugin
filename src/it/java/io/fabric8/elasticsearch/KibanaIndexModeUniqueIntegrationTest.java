...
public class KibanaIndexModeUniqueIntegrationTest extends KibanaIndexModeIntegrationBase {
    ...
    public void testOperationsUserRetrievingDocuments() throws Exception {
        final String [] projects = {"multi-tenancy-1", "multi-tenancy-2", "multi-tenancy-3"};
